...
stats
write.csv(stats,'/home/mrios/workspace/test_R/cog_load-STEAMT024/summary_stats_st.csv')
...
sink("/home/mrios/workspace/test_R/cog_load-STEAMT024/multilevel_brms0b_summary.txt")
text_summ
#tidy(fit1)
sink()
...
write.csv(p_summary, '/home/mrios/workspace/test_R/cog_load-STEAMT024/multilevel_brms0b_psummary.csv')
...
post_fit0b
write.csv(post_fit0b, '/home/mrios/workspace/test_R/cog_load-STEAMT024/multilevel_brms0b_describepost.csv')
...
####
fit2 <- brm(formula = MFD_ST ~ 1 + condition + text + no_of_searches_in_external_resources + PEMT_experience + (1 + condition | participant), 
            data = eyetracking,
...
fit2
tab_model(fit2, file="/home/mrios/workspace/test_R/cog_load-STEAMT024/tab_st.html")
#modelsummary(fit2)
#r_fit2 <- fit2 %>% 
#  tidy() %>% 
...
sink("/home/mrios/workspace/test_R/cog_load-STEAMT024/multilevel_brms2_summary.txt")
text_summ
sink()
#print(fit2)
...
p_summary
write.csv(p_summary, '/home/mrios/workspace/test_R/cog_load-STEAMT024/multilevel_brms2_psummary.csv')
#write.csv(text_summ, '/home/mrios/workspace/test_R/quality/multilevel_brms1_summary.txt')
randeff <- ranef(fit2)
randeff
write.csv(randeff, '/home/mrios/workspace/test_R/cog_load-STEAMT024/multilevel_brms2_randeff.csv')
#plot(fit2)
pp_check(fit2)
...
write.csv(condition_participant_offsets, '/home/mrios/workspace/test_R/cog_load-STEAMT024/multilevel_brms2_condoffsets.csv')
...
post_fit2
write.csv(post_fit2, '/home/mrios/workspace/test_R/cog_load-STEAMT024/multilevel_brms2_describepost.csv')
bayestestR::hdi(fit2)
#-6.28, 6.28
