...
stats <- eyetracking %>%
  group_by(condition) %>%
  get_summary_stats(accuracy_uncorrected, type = "mean_sd")
print(stats, n=83)
write.csv(stats,'/home/mrios/workspace/test_R/prod_error_uncorrected/summary_stats_accuncorrected.csv')


stats <- eyetracking %>%
  group_by(condition) %>%
  get_summary_stats(linguistic_conventions_uncorrected, type = "mean_sd")
print(stats, n=83)
...
#)
#bxp
#ggsave("/home/mrios/workspace/test_R/prod_error_uncorrected/boxplot_pemtspeed.pdf")
##
#condition model
##
fit0 <- brm(formula = pemt_speed ~ 1 + condition + terminology_uncorrected + accuracy_uncorrected + linguistic_conventions_uncorrected + style_uncorrected, #(1 + condition | participant)
            data = eyetracking,
...
sink("/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms0_summary.txt")
text_summ
#tidy(fit1)
sink()
...
write.csv(p_summary, '/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms0_psummary.csv')
...
fit0b <- brm(formula = pemt_speed ~ 1 + condition + text + terminology_introduced + accuracy_introduced + linguistic_conventions_introduced + style_introduced, #(1 + condition | participant)
            data = eyetracking,
...
sink("/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms0b_summary.txt")
text_summ
#tidy(fit1)
sink()
#sjPlot::tab_model(fit1)
...
write.csv(p_summary, '/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms0b_psummary.csv')
...
fit1 <- brm(formula = pemt_speed ~ 1 + condition + text + terminology_uncorrected + accuracy_uncorrected + linguistic_conventions_uncorrected + style_uncorrected, #(1 + condition | participant)
            data = eyetracking,
            warmup = 1000, iter = 10000, chains = 4, cores = 6,
...
sink("/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms1_summary.txt")
text_summ
#tidy(fit1)
sink()
#sjPlot::tab_model(fit1)
...
write.csv(p_summary, '/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms1_psummary.csv')
randeff <- ranef(fit1)
randeff
write.csv(randeff, '/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms1_randeff.csv')
...
write.csv(condition_text_offsets, '/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms1_condoffsets.csv')
...
####
fit2 <- brm(formula = pemt_speed ~ 1 + terminology_uncorrected + accuracy_uncorrected + linguistic_conventions_uncorrected + style_uncorrected + (1 + terminology_uncorrected + accuracy_uncorrected + linguistic_conventions_uncorrected + style_uncorrected | condition), 
            data = eyetracking,
            warmup = 1000, iter = 10000, chains = 4, cores = 6,
...
sink("/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms2_summary.txt")
text_summ
sink()
#print(fit2)
...
p_summary
write.csv(p_summary, '/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms2_psummary.csv')
...
conditional_effects(fit2, effects = 'accuracy_uncorrected:condition', re_formula=NULL)
conditional_effects(fit2, effects = 'terminology_uncorrected:condition', re_formula=NULL)
conditional_effects(fit2, effects = 'linguistic_conventions_uncorrected:condition', re_formula=NULL)
conditional_effects(fit2, effects = 'style_uncorrected:condition', re_formula=NULL)
loo2 <- loo(fit2)

loo_cpm <- loo_compare(loo0, loo0b, loo2)
loo_cpm
write.csv(loo_cpm, '/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms_loo_cpm1-2.csv')
...
write.csv(condition_participant_offsets, '/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms2_condoffsets.csv')
#fixed effect + random offset for text-specific intercepts and slopes.
...
sink("/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms3_summary.txt")
text_summ
sink()
#print(fit2)
#sjPlot::tab_model(fit2)
...
p_summary
write.csv(p_summary, '/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms3_psummary.csv')
#write.csv(text_summ, '/home/mrios/workspace/test_R/quality/multilevel_brms1_summary.txt')
randeff <- ranef(fit3)
randeff
write.csv(randeff, '/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms3_randeff.csv')
plot(fit3)
pp_check(fit3)
...
condition_participant_offsets <- ranef(fit3)$participant %>%
  ...
  select(participant, starts_with("Estimate"))
print(condition_participant_offsets, n=32)
write.csv(condition_participant_offsets, '/home/mrios/workspace/test_R/prod_error_uncorrected/multilevel_brms3_condoffsets.csv')
#fixed effect + random offset for text-specific intercepts and slopes.
