...
#condition model
##
fit0 <- brm(formula = MFD_ST ~ 1 + condition, #(1 + condition | participant)
            data = eyetracking,
...
sink("/home/mrios/workspace/test_R/cog_load/multilevel_brms0_summary.txt")
text_summ
#tidy(fit1)
sink()
...
write.csv(p_summary, '/home/mrios/workspace/test_R/cog_load/multilevel_brms0_psummary.csv')
...
fit0b <- brm(formula = MFD_ST ~ 1 + condition + text, #(1 + condition | participant)
            data = eyetracking,
            warmup = 1000, iter = 5000, chains = 4, cores = 6,
            seed = bayes_seed,
            backend = "cmdstanr"
...
sink("/home/mrios/workspace/test_R/cog_load/multilevel_brms0b_summary.txt")
text_summ
#tidy(fit1)
sink()
#sjPlot::tab_model(fit1)
...
write.csv(p_summary, '/home/mrios/workspace/test_R/cog_load/multilevel_brms0b_psummary.csv')
...
sink("/home/mrios/workspace/test_R/cog_load/multilevel_brms1_summary.txt")
text_summ
#tidy(fit1)
sink()
#sjPlot::tab_model(fit1)
...
write.csv(p_summary, '/home/mrios/workspace/test_R/cog_load/multilevel_brms1_psummary.csv')
randeff <- ranef(fit1)
randeff
write.csv(randeff, '/home/mrios/workspace/test_R/cog_load/multilevel_brms1_randeff.csv')
...
write.csv(condition_text_offsets, '/home/mrios/workspace/test_R/cog_load/multilevel_brms1_condoffsets.csv')
...
####
fit2 <- brm(formula = MFD_ST ~ 1 + condition + text + (1 + condition | participant), 
            data = eyetracking,
            warmup = 1000, iter = 10000, chains = 4, cores = 6,
...
p_summary
write.csv(p_summary, '/home/mrios/workspace/test_R/cog_load/multilevel_brms2_psummary.csv')
#write.csv(text_summ, '/home/mrios/workspace/test_R/quality/multilevel_brms1_summary.txt')
randeff <- ranef(fit2)
randeff
write.csv(randeff, '/home/mrios/workspace/test_R/cog_load/multilevel_brms2_randeff.csv')
plot(fit2)
pp_check(fit2)
...
write.csv(condition_participant_offsets, '/home/mrios/workspace/test_R/cog_load/multilevel_brms2_condoffsets.csv')
#fixed effect + random offset for text-specific intercepts and slopes.
