...
stats
write.csv(stats,'/home/mrios/workspace/imminent_R/Tradumatica_v2/prod_haitransTradumatica2024/summary_stats_st.csv')
...
sink("/home/mrios/workspace/imminent_R/Tradumatica_v2/prod_haitransTradumatica2024/multilevel_brms0b_summary.txt")
text_summ
#tidy(fit1)
sink()
...
write.csv(p_summary, '/home/mrios/workspace/imminent_R/Tradumatica_v2/prod_haitransTradumatica2024/multilevel_brms0b_psummary.csv')
...
post_fit0b
write.csv(post_fit0b, '/home/mrios/workspace/imminent_R/Tradumatica_v2/prod_haitransTradumatica2024/multilevel_brms0b_describepost.csv')
...
####
fit2 <- brm(formula = pemt_speed ~ 1 + condition + text + no_of_searches_in_external_resources + translation_years + PEMT_years + (1 + condition | participant), 
            data = eyetracking,
...
sink("/home/mrios/workspace/imminent_R/Tradumatica_v2/prod_haitransTradumatica2024/multilevel_brms2_summary.txt")
text_summ
sink()
#print(fit2)
...
post_fit2
write.csv(post_fit2, '/home/mrios/workspace/imminent_R/Tradumatica_v2/prod_haitransTradumatica2024/multilevel_brms2_describepost.csv')
...
write.csv(condition_participant_offsets, '/home/mrios/workspace/imminent_R/Tradumatica_v2/prod_haitransTradumatica2024/multilevel_brms2_condoffsets.csv')
