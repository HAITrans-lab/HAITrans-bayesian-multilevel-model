...
eyetracking <- read.csv('/home/mrios/workspace/imminent_R/Tradumatica_v2/prod_cogload_quality_results.csv', header = TRUE, sep = ",")
eyetracking
...
stats
write.csv(stats,'/home/mrios/workspace/imminent_R/Tradumatica_v2/cog_load-STTradumatica24/summary_stats_st.csv')
...
fit0b <- brm(formula = MFD_ST ~ 1 + condition + text + no_of_searches_in_external_resources + PEMT_experience, #(1 + condition | participant)
            data = eyetracking,
...
sink("/home/mrios/workspace/imminent_R/Tradumatica_v2/cog_load-STTradumatica24/multilevel_brms0b_summary.txt")
text_summ
#tidy(fit1)
sink()
...
write.csv(p_summary, '/home/mrios/workspace/imminent_R/Tradumatica_v2/cog_load-STTradumatica24/multilevel_brms0b_psummary.csv')
...
post_fit0b
write.csv(post_fit0b, '/home/mrios/workspace/imminent_R/Tradumatica_v2/cog_load-STTradumatica24/multilevel_brms0b_describepost.csv')
...
####
fit2 <- brm(formula = MFD_ST ~1 + condition + text + no_of_searches_in_external_resources + translation_years + PEMT_years + (1 + condition | participant), 
            data = eyetracking,
...
fit2
tab_model(fit2, file="/home/mrios/workspace/imminent_R/Tradumatica_v2/cog_load-STTradumatica24/tab_st.html")
#modelsummary(fit2)
#r_fit2 <- fit2 %>% 
#  tidy() %>% 
...
sink("/home/mrios/workspace/imminent_R/Tradumatica_v2/cog_load-STTradumatica24/multilevel_brms2_summary.txt")
text_summ
sink()
#print(fit2)
...
p_summary
write.csv(p_summary, '/home/mrios/workspace/imminent_R/Tradumatica_v2/cog_load-STTradumatica24/multilevel_brms2_psummary.csv')
...
post_fit2
write.csv(post_fit2, '/home/mrios/workspace/imminent_R/Tradumatica_v2/cog_load-STTradumatica24/multilevel_brms2_describepost.csv')
bayestestR::hdi(fit2)

randeff <- ranef(fit2)
randeff
write.csv(randeff, '/home/mrios/workspace/imminent_R/Tradumatica_v2/cog_load-STTradumatica24/multilevel_brms2_randeff.csv')
#plot(fit2)
pp_check(fit2)
...
write.csv(condition_participant_offsets, '/home/mrios/workspace/imminent_R/Tradumatica_v2/cog_load-STTradumatica24/multilevel_brms2_condoffsets.csv')
...
(cond_fit <- eyetracking %>%
    ...
    ggplot(aes(x = text, y = MFD_ST, color = ordered(condition), fill = ordered(condition))) +
