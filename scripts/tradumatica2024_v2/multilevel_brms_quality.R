...
stats
write.csv(stats,'/home/mrios/workspace/imminent_R/Tradumatica_v2/qualityTradumatica2024/summary_stats.csv')


stats <- eyetracking %>%
  group_by(condition, translation_years) %>%
  get_summary_stats(quality_score, type = "mean_sd")
stats
#write.csv(stats,'/home/mrios/workspace/imminent_R/Tradumatica_v2/qualityTradumatica2024/summary_stats-trexp.csv')
stats <- eyetracking %>%
  group_by(condition, bins_PEMT_experience) %>%
  get_summary_stats(quality_score, type = "mean_sd")
stats
#write.csv(stats,'/home/mrios/workspace/imminent_R/Tradumatica_v2/qualityTradumatica2024/summary_stats-bins-pemtexp.csv')
...
bxp <- ggplot(eyetracking,aes(eyetracking$translation_years, eyetracking$quality_score,color=eyetracking$condition,group=eyetracking$condition))+geom_line() 
bxp
ggsave("/home/mrios/workspace/imminent_R/Tradumatica_v2/qualityTradumatica2024/boxplot_pemtspeed.png")
...
bxp <- ggboxplot(
  ...
  facet.by = "condition")  + theme( axis.title.x = element_text(size = 20),
                                    ...
                                    axis.text = element_text(size = 16))
bxp
ggsave("/home/mrios/workspace/imminent_R/Tradumatica_v2/qualityTradumatica2024/boxplot_tr_pemtspeed.png")
...
####
fit2 <- brm(formula = quality_score ~ 1 + condition + text + no_of_searches_in_external_resources + translation_years + PEMT_years + (1 + condition | participant), 
            data = eyetracking,
            warmup = 1000, iter = 10000, chains = 4, cores = 6,
...
sink("/home/mrios/workspace/imminent_R/Tradumatica_v2/qualityTradumatica2024/multilevel_brms2_summary.txt")
text_summ
sink()
#print(fit2)
...
p_summary
write.csv(p_summary, '/home/mrios/workspace/imminent_R/Tradumatica_v2/qualityTradumatica2024/multilevel_brms2_psummary.csv')
#write.csv(text_summ, '/home/mrios/workspace/imminent_R/quality/multilevel_brms1_summary.txt')
randeff <- ranef(fit2)
randeff
write.csv(randeff, '/home/mrios/workspace/imminent_R/Tradumatica_v2/qualityTradumatica2024/multilevel_brms2_randeff.csv')
plot(fit2)
pp_check(fit2)
...
write.csv(condition_participant_offsets, '/home/mrios/workspace/imminent_R/Tradumatica_v2/qualityTradumatica2024/multilevel_brms2_condoffsets.csv')
...
post_fit2
write.csv(post_fit2, '/home/mrios/workspace/imminent_R/Tradumatica_v2/qualityTradumatica2024/multilevel_brms2_describepost.csv')
bayestestR::hdi(fit2)
